...
export default function HomePageFeatureBlock() {
   ...
   const slideHeight = (e) => {
       if(buttonWrapperRef.current.classList.contains('active')){
        ...
        gsap.to(toggleHeightRef.current, {duration:1,height:'211.614vw',ease:'ease-in'}); 
       }
       else{
        buttonWrapperRef.current.classList.add('active');
        gsap.to(toggleHeightRef.current, {duration:1,height:'auto',ease:'ease-in'});
       }
       ...
       <MediaContextProvider>
        <section className={styles.featureBlock}>
            <div className={styles.directionArrow}>
                <svg viewBox="0 0 104 98" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M104 48.5831L49 -0.000243485L49 97.1664L104 48.5831Z" fill="#02D9FC"/>
                    <path d="M49 48.5831L-6 -0.000243485L-6 97.1664L49 48.5831Z" fill="#02D9FC"/>
                </svg>
            </div>
