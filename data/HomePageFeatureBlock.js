export const features = {
    title: "The innovators in message commerce.",
    description: `Voyage brands experience the future of text message engagement now. We offer brands the future of text message engagement now through proprietary
     features like "dynamic click to buy" and "one-to-one live conversions."`,
    featureData: [
        {
        ...
        {
            featureTitle: "Custom List Building",
            featureSubtitle: "Build your SMS list with custom-designed modals, Voyage Two-Tap Anywhere & more.",
            featureIcon: "custom-list.svg",
            featureVideo: "custom-listing-building.mp4",
        ...
        },
        {
            ...
            featureVideo: "live-conversation.mp4",
